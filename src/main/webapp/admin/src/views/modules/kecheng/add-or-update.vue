    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="jiaolianId" name="jiaolianId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程时间" prop="kechengDate">
                       <el-input v-model="ruleForm.kechengDate"
                                 placeholder="课程时间" clearable  :readonly="ro.kechengDate"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="课程时间" prop="kechengDate">
                           <el-input v-model="ruleForm.kechengDate"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程价格" prop="kechengNewMoney">
                       <el-input v-model="ruleForm.kechengNewMoney"
                                 placeholder="课程价格" clearable  :readonly="ro.kechengNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="课程价格" prop="kechengNewMoney">
                           <el-input v-model="ruleForm.kechengNewMoney"
