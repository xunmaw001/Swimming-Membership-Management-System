        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="会员类型" prop="huiyuanTypes">
                        <el-select v-model="ruleForm.huiyuanTypes" :disabled="ro.huiyuanTypes" placeholder="请选择会员类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="会员类型" prop="huiyuanValue">
